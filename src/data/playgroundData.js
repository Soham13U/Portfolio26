export const playgroundData = [
  ...
  {
    id: 2,
    title: "Naruto Connections",
    description: "A web based puzzle game where players have to discover hidden connections among sixteen Naruto characters, each belonging to categories such as clans, teams, affiliations, or abilities. By identifying and grouping four characters that share a common attribute, players will progress through the puzzle. Correctly formed groups are locked in, and the objective is to uncover all possible connections within three attempts.",
